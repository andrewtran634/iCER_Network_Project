...
def processFile(filename):
    writeTo = raw_input('Where do you want to store list? ')  #this is the name of the list of bad nodes, make it whatever you want
    times = raw_input('How many standard deviations should constitute a bad node? (enter number) ')
		#this is how many standard deviations away you think is a good threshold for deciding which is a bad node
    ...
    try:
        ...
        print 'File failed to open'
def main(argv):
    fileName = raw_input('What is the file name? ') #this is supposed to be where all the testing data is stored
